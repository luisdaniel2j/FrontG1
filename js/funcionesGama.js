...
function getGama(){
    $.ajax({
        url:"http://192.18.134.29:8080/api/Gama/all",
        type:"GET",
        datatype:"JSON",
...
function postGama(){
    ...
    $.ajax({
        url:"http://192.18.134.29:8080/api/Gama/save",
        type:"POST",
        datatype:"JSON",
...
function putGama(idBotonActualizar){
    ...
    $.ajax({
        url:"http://192.18.134.29:8080/api/Gama/update",
        type:"PUT",
        datatype:"JSON",
...
function deleteGama(idBoton){
    ...
    Swal.fire({
        ...
        $.ajax({
            url:"http://192.18.134.29:8080/api/Gama/"+idBoton,
            type:"DELETE",
            datatype:"JSON",
